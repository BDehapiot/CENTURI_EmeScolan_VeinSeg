/// ----- Initialize ----- ///
	...
	name_ridge_tif = getTitle();
	name_ridge = File.nameWithoutExtension;
...
/// ----- Dialog box ----- ///
	...
	Dialog.addMessage("Ridge marker");
	Dialog.setInsets(-10, 0, 0);
	Dialog.addMessage("----------------------------------------------------");
	
	Dialog.setInsets(0, 0, 0);
	Dialog.addMessage(name_ridge_tif);

	/// ---------------------------------------------------------------------
	
	Dialog.setInsets(10, 0, 0);
	Dialog.addMessage("Cell marker");
	Dialog.setInsets(-10, 0, 0);
	Dialog.addMessage("----------------------------------------------------");	

	name_cell = Dialog.addString("name", "iba1");
	name_cell_add = Dialog.addString("+", "...");
	name_cell_sub = Dialog.addString("-", "...");

	/// ---------------------------------------------------------------------

	Dialog.setInsets(10, 0, 0);
	Dialog.addMessage("Binary masks");
	Dialog.setInsets(-10, 0, 0);
	Dialog.addMessage("------------------------------------------");

	thresh_ridge = Dialog.addNumber("cd31 (threshold)", 30.0000); // parameters
	thresh_cell = Dialog.addNumber("aSMA (threshold)", 45.0000); // parameters
	thresh_cell_add = Dialog.addNumber("iba1 (threshold)", 30.0000); // parameters 
	thresh_cell_sub = Dialog.addNumber("mhc2 (threshold)", 30.0000); // parameters
	...
	name_cell_add = Dialog.getString();
	name_cell_sub = Dialog.getString();
...
/// ----- Dialog box ----- ///
	...
	ridgeCond = Dialog.addString("test condition", "test condition");
